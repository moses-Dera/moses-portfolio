...
export default function Skill(){
    return (
        <motion.div 
            ...
            className="min-h-screen p-8 flex flex-col gap-10 overflow-x-hidden"
        >
            <div className="w-full flex justify-end mb-20">
                <motion.h1 
                    ...
                    className="text-4xl font-jetbrains font-extrabold text-transparent bg-clip-text bg-gradient-to-l from-white to-(--color-accent) text-right"
                >
                    SKILLS{" //"}
                </motion.h1>
            </div>
            ...
            <div className="flex flex-col gap-32 relative w-full">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-4">
                            <span className="text-(--color-accent) font-bold text-xl font-jetbrains">01</span>
                            <div className="w-16 h-[1px] bg-white/20"></div>
                        </div>
                        <h2 className="text-3xl font-bold font-jetbrains mb-4 text-white">System Architecture & Backend Engineering</h2>
                    ...
                    >
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-16 h-[1px] bg-white/20"></div>
                            <span className="text-(--color-accent) font-bold text-xl font-jetbrains">02</span>
                        </div>
                        <h2 className="text-3xl font-bold font-jetbrains mb-4 text-white">Cloud Infrastructure & DevOps</h2>
                        <p className="mb-6 text-lg leading-relaxed text-zinc-400">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-4">
                            <span className="text-(--color-accent) font-bold text-xl font-jetbrains">03</span>
                            <div className="w-16 h-[1px] bg-white/20"></div>
                        </div>
                        <h2 className="text-3xl font-bold font-jetbrains mb-4 text-white">Enterprise Security & Access Control</h2>
                        <p className="mb-6 text-lg leading-relaxed text-zinc-400">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-16 h-[1px] bg-white/20"></div>
                            <span className="text-(--color-accent) font-bold text-xl font-jetbrains">04</span>
                        </div>
                        <h2 className="text-3xl font-bold font-jetbrains mb-4 text-white">AI / LLM Integration</h2>
                        <p className="mb-6 text-lg leading-relaxed text-zinc-400">
            ...
            <motion.div 
                ...
                className="mt-16 flex flex-row justify-end items-center overflow-hidden"
            >
                <div className="p-4 px-10 border border-white text-white font-jetbrains font-bold transition-colors hover:bg-white hover:text-black">
